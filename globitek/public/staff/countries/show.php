...
<?php $page_title = 'Staff: Country ' . h($country['name']); ?>
...
?>
    ...
    <h2>States</h2>
    <br />
    <a href="../states/new.php?cid=<?php echo u($country['id']); ?>">Add a State</a><br />
...
<?php
    ...
    while($state = db_fetch_assoc($state_result)) {
      echo "<li>";
      echo "<a href=\"../states/show.php?id=".raw_u($state['id'])."\">"; //sanitize
      echo h($state['name']);
      echo "</a>";
      echo "</li>";
    } // end while $state
