<?php
  ...
  function validate_state($state, $errors=array()) {
    ...
    } /* MY CUSTOM VALIDATION */elseif (!preg_match('/^\A[a-zA-Z\s]+\Z$/',$state['name'])) {
    ...
    } /* MY CUSTOM VALIDATION */elseif (!preg_match('/^\A[A-Z]+\Z$/',$state['code'])) {
  ...
  function validate_territory($territory, $errors=array()) {
    ...
    if (is_blank($territory['name'])) {
      ...
      $errors[] = "Name must be between 2 and 255 characters.";
    } /* MY CUSTOM VALIDATION */elseif (!preg_match('/^\A[a-zA-Z\s\']+\Z$/',$territory['name'])) {
      $errors[] = "First Name may only contain letters, whitespace and symbols: (') single quotes";
    }
    ...
    if (is_blank($territory['state_id'])) {
      $errors[] = "State ID not found, please return to Main Menu and try again.";
    } /* MY CUSTOM VALIDATION */elseif (mysqli_num_rows(find_state_by_id($territory['state_id']))==0) {
      $errors[] = "Not a valid State ID, please return to Main Menu and try again.";
    }
  ...
  function validate_salesperson($salesperson, $errors=array()) {
    ...
    } /* MY CUSTOM VALIDATION */elseif (!preg_match('/^\A[a-zA-Z\s\']+\Z$/',$salesperson['first_name'])) {
      $errors[] = "First Name may only contain letters, whitespace and symbols: (') single quotes";
    }
    ...
    } /* MY CUSTOM VALIDATION */elseif (!preg_match('/^\A[a-zA-Z\s\']+\Z$/',$salesperson['last_name'])) {
      $errors[] = "Last Name may only contain letters, whitespace and symbols: (') single quotes";
    }
    ...
    if (is_blank($salesperson['email'])) {
      ...
      $errors[] = "Email may only contain letters, numbers and symbols: (_) underscore (@) at  (.) period and (-) hyphen/dash";
    }
    ...
    if (is_blank($salesperson['phone'])) {
      ...
      $errors[] = "Phone may only contain numbers and symbols: (-) hyphen/dash and ( () ) parentheses";
    }
    return $errors;
  }
  ...
  function validate_user($user, $errors=array()) {
    if (is_blank($user['first_name'])) {
      ...
      $errors[] = "First name must be between 2 and 255 characters.";
    } /* MY CUSTOM VALIDATION */elseif (!preg_match('/^\A[a-zA-Z\s\']+\Z$/',$user['first_name'])) {
      $errors[] = "First Name may only contain letters, whitespace and symbols: (') single quotes";
    }
    ...
    if (is_blank($user['last_name'])) {
      ...
      $errors[] = "Last name must be between 2 and 255 characters.";
    } /* MY CUSTOM VALIDATION */elseif (!preg_match('/^\A[a-zA-Z\s\']+\Z$/',$user['last_name'])) {
      $errors[] = "Last Name may only contain letters, whitespace and symbols: (') single quotes";
    } 
